...
HD_PWD='E:/Projects/fpgas/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_baud.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_baud.tcl
